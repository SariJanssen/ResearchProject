...
void AgarioAgent::SetToPersuit(Elite::Vector2 seekPos)
{
	m_pPersuit->SetTarget(seekPos);
	SetSteeringBehavior(m_pPersuit);
}

float AgarioAgent::GetFleeRadius() const
{
	return m_pFlee->As<Flee>()->GetFleeRadius();
}
