...
#elif defined(ActiveApp_FlockingBehaviors)
...
#elif defined(ActiveApp_AStarPathfinding)
	#include "projects\PathfindingAStar\App_PathfindingAStar\App_PathfindingAStar.h"
#elif defined(ActiveApp_NavMeshGraph)
	#include "projects\Movement\Pathfinding\NavMeshGraph\App_NavMeshGraph.h"
#elif defined(ActiveApp_AgarioGame_FSM)
	#include "projects\DecisionMaking\FiniteStateMachines\App_AgarioGame.h"
#elif defined(ActiveApp_AgarioGame_BT)
...
#elif defined(ActiveApp_AgarioGame_IM)
